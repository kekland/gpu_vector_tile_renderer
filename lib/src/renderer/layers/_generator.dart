...
List<String> symbolLayerRendererSetFeatureVerticesGenerator(List<String> vertexEval, List<String> vertexSetters) {
  return [
    ...
    '      final pos1 = Vector2(glyph.x + glyph.width + sdfPadding, glyph.y - sdfPadding);',
    '      final pos2 = Vector2(glyph.x + glyph.width + sdfPadding, glyph.y + glyph.height + sdfPadding);',
    '      final pos3 = Vector2(glyph.x - sdfPadding, glyph.y + glyph.height + sdfPadding);',
    '',
